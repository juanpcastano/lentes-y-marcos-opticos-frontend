...
Simulates an external payment gateway (Placetopay-style) for the checkout flow. Generates a fake transaction ID, simulates a redirect delay, and returns a confirmation status.
