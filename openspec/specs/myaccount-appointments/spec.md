...
The MyAccount appointments feature provides authenticated users a page to view their appointments, split by status into pending and history tabs, with completed appointments displaying medical results.
