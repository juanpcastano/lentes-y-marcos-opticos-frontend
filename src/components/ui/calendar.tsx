  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        dropdowns: cn(
          "flex h-(--cell-size) w-full items-center justify-center gap-1.5 text-base md:text-lg font-medium",
        ...
        caption_label: cn(
          ...
          captionLayout === "label"
            ...
            : "flex items-center gap-1 rounded-(--cell-radius) text-base md:text-lg [&>svg]:size-4 md:[&>svg]:size-5 [&>svg]:text-muted-foreground",
          defaultClassNames.caption_label,
        ),
        month_grid: cn("w-full border-collapse", defaultClassNames.month_grid),
        weekdays: cn("flex gap-1", defaultClassNames.weekdays),
        weekday: cn(
          "flex-1 rounded-(--cell-radius) text-[0.9rem] md:text-base font-normal text-muted-foreground select-none",
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          if (orientation === "left") {
            return (
              <ChevronLeftIcon
                className={cn("size-5 md:size-6", className)}
                {...props}
              />
            )
          }
